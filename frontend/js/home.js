document.addEventListener("DOMContentLoaded", () => {
    ...
    // Ambil produk dari API dan tampilkan (hanya 4 produk unggulan)
    const fetchFeaturedProducts = async () => {
        try {
            ...
            // Ambil hanya 4 produk pertama sebagai produk unggulan
    ...
    // Event listener untuk tombol "Tambah ke Keranjang" (reusable)
    productContainer.addEventListener("click", async (e) => {
        if (e.target.classList.contains("add-to-cart")) {
            ...
            button.previousElementSibling.textContent = `Stok: ${stock - 1}`;
            if (stock - 1 === 0) {
